  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Doctor Appointment System - Your Gateway to Simplified Health Management. Schedule, Manage, and Track Appointments with Ease."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Doctor Appointment System - Your Gateway to Simplified Health Management. Schedule, Manage, and Track Appointments with Ease.`}
            </Text>
            <Box
